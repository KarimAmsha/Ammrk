/*********************        Yousef El-Madhoun        *********************/
//
//  TrainingRoomsViewController.swift
//  amrk
//
...
class TrainingRoomsViewController: UIViewController, CLLocationManagerDelegate {
...
extension TrainingRoomsViewController {
    ...
    func setupView() {
        ...
        self.dwSelectCity.font = UIFont(name: "NeoSansArabic", size: 18)
        ...
        self.dwSelectRestaurantType.font = UIFont(name: "NeoSansArabic", size: 18)
        ...
        self.tableView.register(UINib(nibName: "TrainingRoomTableViewCell", bundle: nil), forCellReuseIdentifier: "TrainingRoomTableViewCell")
    }
...
extension TrainingRoomsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TrainingRoomTableViewCell", for: indexPath) as! TrainingRoomTableViewCell
...
extension TrainingRoomsViewController: UITextFieldDelegate {
...
extension TrainingRoomsViewController: FSPagerViewDelegate, FSPagerViewDataSource {
...
extension TrainingRoomsViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
